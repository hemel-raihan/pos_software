...
$("#kitchen_slip").click(function(){
	kitchen(print=true,pay_all=true);
});
$("#guest_bill").click(function(){
	guest(print=true,pay_all=false);
});
...
function guest(print=false,pay_all=false){
			...
			success: function(result){
				...
				if(result[0]){
					...
					if(result[0]=="success")
					{
						var print_done=true;
						if(print){
							var print_done =window.open(base_url+"pos/print_guest_invoice_pos/"+result[1], "_blank", "scrollbars=1,resizable=1,height=300,width=450");
						}
						if(print_done){
...
function kitchen(print=false,pay_all=false){
				...
				success: function(result){
					...
					if(result[0]){
						...
						if(result[0]=="success")
						{
							...
							var print_done=true;
							if(print){
								var print_done =window.open(base_url+"pos/print_kitchen_invoice_pos/"+result[1], "_blank", "scrollbars=1,resizable=1,height=300,width=450");
							}
							if(print_done){
...
$('#guest_hold_invoice').click(function (e) {
