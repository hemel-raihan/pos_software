...
function calculate_purchase_price(){
	...
	var gov_sd = (isNaN(parseFloat($("#gov_sd").val().trim()))) ? 0 :parseFloat($("#gov_sd").val().trim()); 
	
	tax = parseFloat(tax);
	gov_sd = parseFloat(gov_sd);

	gov_sdpercent = (price*gov_sd)/parseFloat(100);
	...
	if(tax_type=='Inclusive'){
		...
		purchase_price = (price + gov_sdpercent + (price*tax)/parseFloat(100));
	}
