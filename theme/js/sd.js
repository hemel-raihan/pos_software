...
$('#save,#update').click(function (e) {
    ...
    if(this_id=="save")  //Save start
    {
    				...
    				if(confirm("Are you sure ?")){
						e.preventDefault();
						data = new FormData($('#sd-form')[0]);//form name
						/*Check XSS Code*/
...
{
	$.post("sd/update_status",{id:id,status:status},function(result){
...
//update status end
//Delete Record start
function delete_sd(q_id)
{
   if(confirm("Are you sure ?")){
   	$(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
   $.post("sd/delete_sd",{q_id:q_id},function(result){
   //alert(result);return;
	   if(result=="success")
				{
