...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('todaysales/ajax_list')?>",
            "type": "POST",
...
<script type="text/javascript">
  ...
  window.open("<?= base_url();?>pos/print_kitchen_invoice_pos/"+id, "_blank", "scrollbars=1,resizable=1,height=500,width=500");
}
</script>
<script type="text/javascript">
  function print_pos_invoice(id){
