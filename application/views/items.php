                        ...
                        <div class="box-body">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <?php if(isset($gov_sd))
                                 { ?>
                                    <label for="custom_barcode" >Gov SD (%)</label>
                                    <input type="number" class="form-control" id="gov_sd" name="gov_sd" placeholder="Gov SD in Percentage (Optional)"  value="<?php print $gov_sd; ?>" >
                                 <?php }

                                 else
                                 {?>
                                    <label for="custom_barcode" >Gov SD (%)</label>
                                    <input type="number" class="form-control" id="gov_sd" name="gov_sd" placeholder="Gov SD in Percentage (Optional)"  value="0" >
                               <?php  }?>
                              ...
                              <div class="form-group col-md-4">
                                 <label for="purchase_price"><?= $this->lang->line('total_price'); ?><span class="text-danger">*</span></label>
