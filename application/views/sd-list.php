        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>sd/add">
                <i class="fa fa-plus">New SD</a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-header -->
...
<script src="<?php echo $theme_link; ?>js/sd.js"></script>
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('sd/ajax_list')?>",
            "type": "POST",
