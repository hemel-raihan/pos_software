      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <span id="phone_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                  <label for="wifi_pass" class="col-sm-4 control-label">Wifi Password</label>

                  <div class="col-sm-8">
                    <input type="text" class="form-control " id="wifi_pass" name="wifi_pass" placeholder="" value="<?php print $wifi_pass; ?>" onkeyup="shift_cursor(event,'gstin')" >
          <span id="wifi_password" style="display:none" class="text-danger"></span>
                  </div>
                  </div>
