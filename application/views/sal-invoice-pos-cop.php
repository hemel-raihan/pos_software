				...
				<!--		<th style="font-size: 11px; text-align: right;padding-left: 2px; padding-right: 2px;"><?= $this->lang->line('discount'); ?></th>  -->
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						<?php
			              ...
			              $tax_amt=0;
						  $gov=0;
			              $q2=$this->db->query("select  b.sales_price, a.discount_type,a.discount_input,a.discount_amt, b.item_name, b.gov_sd, a.sales_qty,a.unit_total_cost,a.price_per_unit,a.tax_amt,c.tax,a.total_cost from db_salesitems a,db_items b,db_tax c where c.id=a.tax_id and b.id=a.item_id and a.sales_id='$sales_id'");
			              foreach ($q2->result() as $res2) {
							$subtotal+=($res2->total_cost);
							$tax_amt+=$res2->tax_amt;
							$before_tax = $subtotal-$tax_amt;
							$gov += ($res2->gov_sd);
							$gov_sdpercent =($res2->sales_price*$gov)/100;
							$sales_qt = $res2->sales_qty;
							$total_with_qty = $res2->price_per_unit*$sales_qt;
			                  echo "<tr>";  
					...
					<tfoot>
					 ...
					 <!-- <tr >
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="4" align="right">Before VAT</td>
	                ...
	                <!-- <tr>
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="4" align="right"><?= $this->lang->line('other_charges'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px;" align="right"><?= $other_charges_amt; ?></td>
					</tr> -->
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="4" align="right">Gov SD</td>
						<td style=" padding-left: 2px; padding-right: 2px;" align="right"><?= number_format(($gov_sdpercent),2,'.','');?></td>
					</tr>
					...
					<tr>
						<td colspan="6" align="center"><strong>----------<?= $this->lang->line('thanks_you_visit_again'); ?>----------</strong></td>
					</tr>
