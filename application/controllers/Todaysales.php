...
class Todaysales extends MY_Controller {
	public function __construct(){
		parent::__construct();
		$this->load_global();
		$this->load->model('todaysales_model','sales');
	...
	public function index()
	{
		...
		$data=$this->data;
		$data['page_title']='Todays Sales List';
		$this->load->view('todays-sales-list',$data);
	}
	public function add()
	{	
		...
		foreach ($list as $sales) {
			...
			$row[] = ucfirst($sales->created_by);
					...
					$str2 = '<div class="btn-group" title="View Account">
                                        ...
                                        <i class="fa fa-fw fa-file-text text-blue"></i>KOT Invoice
                                        </a>
										<a style="cursor:pointer" title="Print KOT Invoice ?" onclick="print_pos_invoice('.$sales->id.')">
