...
class Company_model extends CI_Model {
	...
	public function get_details(){
		...
		if($query->num_rows()==0){
			...
			$data['wifi_pass']=$query->wifi_pass;
	...
	public function update_company(){
		...
		/*End*/
		$query1="update db_company set company_name='$company_name',mobile='$mobile',phone='$phone',wifi_pass='$wifi_pass',email='$email',country='$country',state='$state',city='$city',postcode='$postcode',address='$address',gst_no='$gstin',vat_no='$vat',website='$website', pan_no='$pan',bank_details='$bank_details',upi_id='$upi_id' $company_logo $upi_code where id=$q_id";
